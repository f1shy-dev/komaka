...
fn main() {
    let mut VALUE = 5;
    println!("Initial value of VALUE: {}", VALUE);

    VALUE = calculate_new_value(VALUE, 10);
    ...
    println!(
        "The area of the rectangle is {} square piVALUEels.",
        rect1.area()
    );
    ...
    match VALUE {
        ...
        _ if VALUE % 2 == 0 => println!("VALUE is an even number greater than 10"),
        _ => println!("VALUE is an odd number greater than 10"),
    }
    ...
    let p1 = Point { VALUE: 5, y: 10.4 };
    let p2 = Point { VALUE: "Hello", y: 'c' };
    
    println!("p1: {{ VALUE: {}, y: {} }}", p1.VALUE, p1.y);
    println!("p2: {{ VALUE: {}, y: {} }}", p2.VALUE, p2.y);
